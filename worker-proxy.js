  ...
  const CUSTOM_SCRIPT = `
    <script src="https://twinsielab.github.io/site/notion-custom-notes.js"></script>
  `;
...
element(element) {
  ...
  // hide "Try Notion" button
  element.append(
    `<style>
    div.notion-topbar > div > div:nth-child(3) { } /*comments*/
    div.notion-topbar > div > div:nth-child(5) { display: none !important; } /*more btn*/
    div.notion-topbar > div > div:nth-child(6) { display: none !important; } /*dived*/
